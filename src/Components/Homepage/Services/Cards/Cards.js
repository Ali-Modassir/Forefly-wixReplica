...
const Cards = (props) => {
  ...
  } else if (type === "Daily Housekeeping") {
    logo.push(
      <svg
        preserveAspectRatio="xMidYMid meet"
        id="comp-iu44j9ttsvgcontent"
  ...
  } else if (type === "In-Room Dining Service") {
    logo.push(
      <svg
        preserveAspectRatio="xMidYMid meet"
        id="comp-iu44io8fsvgcontent"
  ...
  return (
    <div className={styles.cards}>
      ...
      <div className={styles.logoName}>{type}</div>
